...
typedef enum {mod_brush, mod_sprite, mod_alias, mod_halflife, mod_md3} modtype_t;
...
int GL_LoadTexture32 (char *identifier, int width, int height, byte *data, qboolean mipmap, qboolean alpha);		//naievil HLBSP
void Build_Gamma_Table (void);	//naievil hlbsp
