...
// we got at least GL3.2 here -- these are now in the base standard

#define GL_TEXTURE0_ARB GL_TEXTURE0
#define GL_TEXTURE1_ARB GL_TEXTURE1

#define PFNGLMULTITEXCOORD2FARBPROC PFNGLMULTITEXCOORD2FPROC
#define PFNGLACTIVETEXTUREARBPROC PFNGLACTIVETEXTUREPROC
#define PFNGLCLIENTACTIVETEXTUREARBPROC	PFNGLCLIENTACTIVETEXTUREPROC
#define PFNGLBINDBUFFERARBPROC PFNGLBINDBUFFERPROC
#define PFNGLBUFFERDATAARBPROC PFNGLBUFFERDATAPROC
#define PFNGLBUFFERSUBDATAARBPROC PFNGLBUFFERSUBDATAPROC
